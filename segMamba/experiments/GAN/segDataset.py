...
class ImageDataset(Dataset):
    def __init__(self, dtype, device, imgType="enhanced"):
        ...
        if dtype == 'train':
            self.prefix = '../../../Diffusion_based_Image_Enhancement-master/experiments/dataSegGAN/train'
            valid_exts = ('.tif')
            ...
            self.prefix = '../../../Diffusion_based_Image_Enhancement-master/experiments/dataSegGAN/valid'
            valid_exts = ('.tif')
            mask_dir = os.path.join(self.prefix, 'mask')
